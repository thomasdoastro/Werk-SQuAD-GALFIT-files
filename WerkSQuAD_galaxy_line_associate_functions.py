...
def reduce_data(lines_galfit):
    ...
    good_slice = axis_ratio_slice[axis_ratio_slice['host_good_fit'] == True]
    
    # slice to only include models where HLR > 3 pixels
    final_reduction = good_slice[good_slice['host_big'] == True]
